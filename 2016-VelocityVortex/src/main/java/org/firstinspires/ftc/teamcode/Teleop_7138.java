...
/**
 */
@TeleOp(name="Teleop_7138", group="Iterative Opmode")  // @Autonomous(...) is the other common choice

public class Teleop_7138 extends OpMode
{
...
//    double autoLoadDetectTimer = 0.0;
    ...
    boolean tankOverHaloDrive = true;
    ...
    public void init() {
        ...
        leftButtonServo.setPosition(0.71);
        rightButtonServo.setPosition(0.33);  // .29
...
//        }
        ...
        if (gamepad1.right_trigger > 0.0 || gamepad2.right_trigger > 0.0)
            leftButtonServo.setPosition(1.0);
        else
            leftButtonServo.setPosition(0.71);

        if (gamepad1.left_trigger > 0.0 || gamepad2.left_trigger > 0.0)
            rightButtonServo.setPosition(0.0);
        else
            rightButtonServo.setPosition(0.33);
